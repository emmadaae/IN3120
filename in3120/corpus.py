...
class InMemoryCorpus(Corpus):
    ...
    def __init__(self, filename: str = None, pipeline: DocumentPipeline = None):
        self._documents = []
    ...
    def split(self, field_name: str, splitter: Callable[[Any], List[Any]] = None) -> Dict[Any, InMemoryCorpus]:
        """
